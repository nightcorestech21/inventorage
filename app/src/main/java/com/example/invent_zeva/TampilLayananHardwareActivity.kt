...
class TampilLayananHardwareActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tampil_layanan_hardware)

        tableLayout = findViewById(R.id.tabelLayananHardware)
        btnTambah = findViewById(R.id.btnTambahLayanan)

        database = FirebaseDatabase.getInstance().getReference("layanan_hardware")

        btnTambah.setOnClickListener {
            val intent = Intent(this, AddLayananHardwareActivity::class.java)
        ...
        database.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (child in snapshot.children) {
                    ...
                    val software = child.child("namaHardware").value?.toString() ?: "-"
                    val hardware = child.child("jenisHardware").value?.toString() ?: "-"

                    val row = TableRow(this@TampilLayananHardwareActivity).apply {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@TampilLayananHardwareActivity, "Gagal memuat data", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun makeDeleteButton(id: String): LinearLayout {
        ...
        val btnDelete = Button(this).apply {
            ...
            textSize = 10f
            setOnClickListener {
                AlertDialog.Builder(this@TampilLayananHardwareActivity).apply {
                    setTitle("Konfirmasi")
